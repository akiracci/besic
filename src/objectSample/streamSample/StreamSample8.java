...
class StreamSample8 {
    public static void main(String[] args) {
        ...
        System.out.print("値の一覧: ");
        System.out.println(integerList);

        System.out.print("最初の要素: ");
        ...
        integerList.stream().max(Comparator.naturalOrder()).ifPresent(System.out::println);//6
        ...
        List<Integer> distinctList = integerList.stream().distinct().collect(Collectors.toList());//distinct 164p
...
//https://docs.oracle.com/javase/jp/11/docs/api/java.base/java/util/stream/Collectors.html //Collectors
        //https://docs.oracle.com/javase/jp/11/docs/api/java.base/java/util/stream/Collectors.html#toMap(java.util.function.Function,java.util.function.Function) //.toMap
