package objectSample.detaTimeSumple1;

import java.time.LocalDateTime;
import java.time.Month;

public class DetaTimeSample2 {
    public static void main(String[] args) {


        LocalDateTime someDateTime = LocalDateTime.of(1981, Month.NOVEMBER, 25, 18, 0);
